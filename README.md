...
| [<img src="leetcode.png" width="25px"/>](https://leetcode.com/problems/remove-duplicates-from-sorted-array/) [<img src="interviewbit.png" width="25px"/>](https://www.interviewbit.com/problems/remove-duplicates-from-sorted-array/)| [Remove Duplicates from Sorted Array](/0026.Remove_Duplicates_from_Sorted_Array) | Easy | 5.39% | 78.19% | `Amazon` `Google` `Microsoft` `United Healthgroup` `Expedia` |  |
